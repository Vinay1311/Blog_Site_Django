...
SECRET_KEY = 'django-insecure-%_zh_vm@6xv@gj+q-7x#@u7dagliczhet*)8-xk&1iw8@6+0i*'
...
MIDDLEWARE = [
    ...
    'middleware.admin_role_middleware.RestrictDeleteBlogToAdminMiddleware',
]
